			...
			runButton.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent ae) {
					...
					try {
						...
						// works
						/*
						 bash -c "javac /Users/ranger/Desktop/java/testjavafolder/Output.java"
						 bash -c "cd /Users/ranger/Desktop/java/testjavafolder && ls"
						 bash -c "cd /Users/ranger/Desktop/java/testjavafolder; ls"
						 
						 bash -c "cd /Users/ranger/Desktop/java/testjavafolder && javac *.java && java Output"
						 
						 works kind of bulky though
						 eh fuck it just build a quoted string 
						 
						 have to build whole quoted string if multiple commands
...
//						String[] splitted = compileString.split(" ");
//						
//						for(String qs: splitted) {
//							args.add(qs);
//						}
